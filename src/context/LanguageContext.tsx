...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "cart.tip": { es: "Propina", en: "Tip" },
  "cart.tip.other": { es: "Otro", en: "Other" },
  ...
  "cart.error.date": { es: "Selecciona una fecha de entrega", en: "Please select a delivery date" },
  "cart.error.address": { es: "Escribe tu dirección de entrega", en: "Please enter your delivery address" },
